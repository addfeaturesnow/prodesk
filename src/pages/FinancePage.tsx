...
export default function FinancePage() {
  ...
  const loadFinancialSummary = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load financial data. Make sure the API server is running on port 3000.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">${summary.equipmentInventoryValue.toFixed(2)}</div>
